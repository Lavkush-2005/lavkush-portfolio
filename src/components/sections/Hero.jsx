  ...
  return (
    ...
    >
      ...
      >
       ...
       <motion.div
  variants={item}
  className="glass relative mx-auto flex aspect-[3/4] w-full max-w-[350px] overflow-hidden items-center justify-center rounded-2xl border border-dashed border-border"
>
  <img
